"""
Django settings for Sherpany Assignment project.
...
# BASE_DIR required for manage.py clean_pyc
BASE_DIR = ROOT_DIR
...
# EMAIL CONFIGURATION
# ------------------------------------------------------------------------------
EMAIL_SUBJECT_PREFIX = "[Sherpany Assignment] "
...
LOGGING = {
    ...
    "loggers": {"prawcore": {"handlers": ["console"], "level": "DEBUG"}},
}
